<template>
<div id="Impressum_Homepage">
    <div class="container-fluid" style="background: #708090;">
      <div class="row">
        <h2><span style="color:white;"><br>Impressum</span></h2>
        <div class="alert alert-light" role="alert"> 
          <div class='impressum'><p>Angaben gemäß § 5 TMG</p><p>Kleider für Herz e.V. <br> 
          Musterstraße 1<br> 
          ...
          Fax: 01234-56789<br>
          E-Mail: max@mustermann.de<br></p><p><strong>Umsatzsteuer-ID: </strong> <br>
